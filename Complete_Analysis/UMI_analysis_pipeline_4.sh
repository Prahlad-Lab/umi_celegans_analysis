...
STAR_INDEX="/vscratch/grp-vprahlad/umi_analysis/data/star_index" # This directory will be created
PYTHON_SCRIPT_PATH="/projects/rpci/vprahlad/umi_celegans/analysis_broad/calculate_allele_proportions_depth10.py"

# --- Output Directories ---
BASE_OUTPUT_DIR="/vscratch/grp-vprahlad/umi_analysis/data/output_subset"
