...
# --- Input/Reference ---
DIR_SEQS="/projects/rpci/vprahlad/umi_celegans/data/"
DIR_REF_INPUT="/projects/rpci/vprahlad/umi_celegans/data/input"
DIR_VCF_INPUT="/projects/rpci/vprahlad/umi_celegans/data/input"
...
STAR_INDEX="/projects/rpci/vprahlad/umi_celegans/data/output/star_index"
...
conda activate STAR # As specified in the original STAR script
