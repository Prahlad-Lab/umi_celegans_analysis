...
output_dir <- "../output/Allelic_proportions"
...
#setwd("../Family_size1_allele_proportions_depth10")
# --- 2. Define Input File Paths ---
# Define the directory where the files are located.
data_directory <- "../Family_size1_allele_proportions_depth"
...
if (nrow(
  ...
  ggsave(filename = file.path(output_dir,output_filename_violin), plot = violin_plot, width = 4, height = 3.5, dpi = 300)
...
variant_sites_proportion_PRDE1 = total_prde1_variant_sites/total_prde1
...
write.csv(table.number.sites.proportion.variant.sites,file = file.path(output_dir,"table.number.sites.proportion.variant.sites.csv"))
...
write.csv(frequency_table_data_variant_sites, file = file.path(output_dir,"frequency_table_data_variant_sites.csv"))
...
write.csv(frequency_table_data_all_sites, file = file.path(output_dir,"frequency_table_data_all_sites.csv"))
