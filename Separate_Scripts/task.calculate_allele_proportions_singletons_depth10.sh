...
#SBATCH --job-name="calculate_allele_proportions_singletons_depth10"
#SBATCH --output=stdout/task.calculate_allele_proportions_singletons_depth10.out
...
proportions_dir="/vscratch/grp-vprahlad/umi_analysis/data/output_broad/Family_size1_allele_proportions_depth10"

# --- NOTE ---
# The original script assumed the python script 'calculate_allele_proportions_depth10.py'
...
SCRIPT_PATH="/projects/rpci/vprahlad/umi_celegans/analysis_broad/calculate_allele_proportions_depth10.py"
